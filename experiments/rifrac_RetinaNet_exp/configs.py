...
class configs(DefaultConfigs):
    ...
    def __init__(self, server_env=False):
        ...
        self.csv_file='ribfrac-train-info.csv'
        self.pp_dir = os.path.join(self.root_dir,"data_int_npz")
        ...
        self.test_aug = False
        # if save batch data
        self.save_batch_data = True
        #result
        self.save_final_result=True

        # int [0 < dataset_size]. select n patients from dataset for prototyping. If None, all data is used.
        self.select_prototype_subset = None

        # path to preprocessed data.
        self.pp_name = 'data_int_npz'
        self.input_df_name = 'info_df.pickle'
        self.pp_data_path = os.path.join("experiments/rifrac_RetinaNet_exp/data",self.pp_name)
