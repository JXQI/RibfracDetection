...
if __name__ == '__main__':
    ...
    exp_source="../rifrac_RetinaNet_exp/"
    exp_dir="../rifrac_RetinaNet_debug/"
    server_env=False
    ...
    examples_image = os.path.join(cf.pp_data_path,"RibFrac{}_img.npz".format(file_pid))
    # examples_label = os.path.join(cf.pp_data_path, "RibFrac{}_rois.npz".format(file_pid))
    examples_info  = os.path.join(cf.pp_data_path, "meta_info_RibFrac{}.pickle".format(file_pid))
    shutil.copy(examples_image,os.path.join(test_path,"RibFrac{}_img.npz".format(file_pid)))
    # shutil.copy(examples_label, os.path.join(test_path, "RibFrac{}_rois.npz".format(file_pid)))
    ...
    copy_time=time.time()
    print("spend time coping ={}".format(copy_time-test_begin))
    ...
    test_end=time.time()
    print("spend time={}".format(test_end-test_begin))
