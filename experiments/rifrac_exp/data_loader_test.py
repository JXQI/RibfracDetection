...
def get_train_generators(cf, logger,testset="train"):
    """
    ...
    if testset=='val':
        train_ix=val_ix
        train_data=val_data
    logger.info("data set loaded with: {} {} patients".format(len(train_ix),testset))
    batch_gen = {}
    batch_gen['test'] = create_data_gen_pipeline(train_data, cf=cf, is_training=False)
    batch_gen['n_test']=cf.num_train_batches
