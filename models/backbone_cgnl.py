...
class FPN(nn.Module):
    ...
    def __init__(self, cf, conv, operate_stride1=False):
        ...
        for i in range(1, self.n_blocks[1]):
            if (self.n_blocks[1]==4 and i==3) or (self.n_blocks[1]==4 and i==1):
                C3_layers.append(cgnl.SpatialCGNL(start_filts_exp*2,int(start_filts_exp),use_scale=False,groups=4))
        ...
        for i in range(1, self.n_blocks[2]):
            if (self.n_blocks[2]==6 and i==1) or (self.n_blocks[2]==6 and i==3) or (self.n_blocks[2]==6 and i==5) :
                C4_layers.append(cgnl.SpatialCGNL(start_filts_exp*4,int(start_filts_exp*2),use_scale=False,groups=4))
