...
class net(nn.Module):
    ...
    def seg_box(self,results_dict, seg_probs, var_seg_ohe, var_seg):
        ...
        args:
            results_dict: objects results,box (y1, x1, y2, x2, (z1), (z2)
            seg_features: 需要分割的feature maps
            var_seg_ohe,var_seg: 计算loss所需要的label
        return:
            seg_results: 每个box分割的map
            seg_sum_dice: dice loss总和
